...
export default function HomePage() {
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose Sydney Harbor Hostel?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">High-speed internet throughout the hostel to keep you connected</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">Spacious kitchen, lounge areas, and rooftop terrace for socializing</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">24/7 security, lockers in every room, and keycard access</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">Round-the-clock assistance and check-in flexibility</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">Meet fellow travelers from around the world in our vibrant community</p>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-blue-600">$35/night</span>
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-blue-600">$28/night</span>
                  <div className="flex items-center">
                    <Star className="h-4 w-4 text-yellow-400 fill-current" />
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Comfortable private room with shared bathroom facilities</p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-blue-600">$75/night</span>
                  <div className="flex items-center">
                    <Star className="h-4 w-4 text-yellow-400 fill-current" />
      ...
      {/* CTA Section */}
      <section id="book" className="py-16 bg-blue-600 text-white">
